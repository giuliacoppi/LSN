...
int main (int argc, char *argv[]){
    ...
    initial_position_100.assign(3, 10*a); //STARTING FAR AWAY FROM THE ORIGIN, P=0 never for 100
    initial_position_210.assign(3, 10*a); //STARTING FAR AWAY FROM THE ORIGIN, P=0 in r=0 and xy plane (z=0) for 210
