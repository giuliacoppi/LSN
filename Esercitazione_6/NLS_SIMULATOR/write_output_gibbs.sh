...
# output files names
OUTPUT_U="./DATA_ANALYSIS/gibbs_total_energy.dat"
OUTPUT_CV="./DATA_ANALYSIS/gibbs_specific_heat.dat"
OUTPUT_CHI="./DATA_ANALYSIS/gibbs_susceptibility.dat"
OUTPUT_MAGNET="./DATA_ANALYSIS/gibbs_magnetization.dat"
...
do
    FILE_U="./RESULTS/GIBBS/T_$T/total_energy.dat"
    FILE_CV="./RESULTS/GIBBS/T_$T/specific_heat.dat"
    FILE_CHI="./RESULTS/GIBBS/T_$T/susceptibility.dat"
    FILE_M="./RESULTS/GIBBS/MAGNET/T_$T/magnetization.dat"
