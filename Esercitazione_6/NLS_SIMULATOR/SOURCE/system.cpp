...
void System :: read_configuration(){
  ...
  if(cinf.is_open()){
    ...
    for(int i=0; i<_npart; i++){
      ...
      _particle(i).setposition(0, this->pbc(_side(0)*x/2, 0)); //I have put my particle in a box of L=L/2
      _particle(i).setposition(1, this->pbc(_side(1)*y/2, 1)); //I have put my particle in a box of L=L/2
      _particle(i).setposition(2, this->pbc(_side(2)*z/2, 2)); //I have put my particle in a box of L=L/2
